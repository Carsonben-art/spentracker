...
import { Typography, textField, Grid, Button, formControl, InputLabel, Select, MenuItem, FormControl, TextField } from '@material-ui/core';
...
const Form = () => {
    ...
    // All initial data is set using this useState hook.
